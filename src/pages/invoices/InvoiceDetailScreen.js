...
function InvoiceDetailScreen(props) {
  ...
  const toggleViewMode = useCallback(() => {
    if (invoiceForm.statusIndex !== "1" && isViewMode) {
      toast.warn("يمكن التعديل فقط في (Draf Mode)", {
  ...
  const addPercentageTax = useCallback(() => {
    ...
    if (isSomeTaxes) {
      toast.error("قد قمت باضافة ضريبة مسبقا", {
        position: "bottom-center",
        autoClose: 2000,
      });
      return;
        ...
        >
            ...
            >
              ...
              >
                <p className="font-bold mb-2">
                  {invoiceForm?.companyDetail?.companyName || "أسم الشركة"}
                </p>
                <p className="text-sm font-medium">
                  {invoiceForm?.companyDetail?.billingAddress ||
                    "لرجاء ادخال بيانات الشركة"}
                </p>
                <p className="text-sm font-medium">
                  {invoiceForm?.companyDetail?.companyMobile || "رقم الهاتف"}
                </p>
                <p className="text-sm font-medium">
          ...
          >
              ...
              <div className="client-form-wrapper sm:w-1/2">
                ...
                >
                  {!isViewMode ? (
                    <input
                      autoComplete="nope"
                      placeholder="العنوانs"
                      className={defaultInputSmStyle}
                      value={invoiceForm?.clientDetail?.billingAddress}
                      onChange={(e) =>
                        handlerInvoiceClientValue(e, "العنوان")
                      }
                    />
                  ) : (
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-row justify-between items-center mb-1">
                <div className="font-title flex-1"> التاريخ </div>
                <div className="font-title flex-1 text-right">
                  <DatePicker
              ...
              <div className="flex flex-row justify-between items-center mb-1">
                <div className="font-title flex-1"> تاريخ الاستحقاق </div>
                <div className="font-title flex-1 text-right">
                  <DatePicker
              ...
              {!isViewMode && (
                <div className="flex flex-row justify-between items-center mb-1">
                  <div className="font-title flex-1"> العملة </div>
                  <div className="font-title flex-1 text-right">
                    <input
                      autoComplete="nope"
                      placeholder=""
          ...
          <div className="py-2 px-4">
            ...
            >
              ...
              >
                <span className="inline-block">التفاصيل</span>
              </div>
              <div
                className={
                  "font-title " +
                ...
                {!isViewMode && (
                  ...
                  >
                    <div className="w-full text-red-500 font-title h-8 sm:h-8 sm:w-8 cursor-pointer rounded-2xl bg-red-200 mr-2 flex justify-center items-center">
                      ...
                      <span className="block sm:hidden">جذف المنتج</span>
                    </div>
                  </div>
                )}
              </div>
